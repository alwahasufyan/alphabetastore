...
export default function SidebarAccordion({
  ...
  const hasActiveChild = useMemo(() => item?.children?.some(li => li.path === pathname), [item?.children, pathname]);
  ...
  return <NavExpandRoot className="subMenu">
      <NavItemButton onClick={handleClick} active={hasActiveChild ? 1 : 0} sx={{
